...
Quelle: [Wikipedia](https://en.wikipedia.org/wiki/Unicode#Versions)
...
Quelle: Beispiele aus [Wikipedia](https://de.wikipedia.org/wiki/Alphabetische_Sortierung#Beispiel_f%C3%BCr_deutschsprachige_Sortierungen)
